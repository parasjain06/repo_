...
import cv2
import dlib
from src.gaze.gazeUtility.eye import Eye
from src.gaze.gazeUtility.calibration import Calibration
...
class GazeTracking(object):
    ...
    def is_right(self):
        """Returns true if the user is looking to the right""" #35
        if self.pupils_located:
            return self.horizontal_ratio() <= 0.50

    def is_left(self):
        """Returns true if the user is looking to the left""" #65
        if self.pupils_located:
